...
public class Organ_Hospital_Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organ_hospital);
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerViewBloodBankso);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                response -> {
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(Organ_Hospital_Activity.this, "Error1: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                },
                error -> Toast.makeText(Organ_Hospital_Activity.this, "Error2: " + error.getMessage(), Toast.LENGTH_SHORT).show()
        );
