...
public class Reciever_Blood_Bank_Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reciever_blood_bank);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                response -> {
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(Reciever_Blood_Bank_Activity.this, "Error1: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                },
                error -> Toast.makeText(Reciever_Blood_Bank_Activity.this, "Error2: " + error.getMessage(), Toast.LENGTH_SHORT).show()
        );
