...
public class donor_singupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_singup);

        databaseHelper = new DatabaseHelper(this);
        button_singup=findViewById(R.id.singup_button);
        editText_name=findViewById(R.id.singup_name);
        editText_mno=findViewById(R.id.singup_phone);
        editText_email=findViewById(R.id.singup_email);
        editText_address=findViewById(R.id.singup_address);
        editText_password=findViewById(R.id.singup_password);
        ...
        button_singup.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if (validateFields())
                {
                    ...
                    if (success)
                    {
                        Toast.makeText(donor_singupActivity.this, "Signup successful!", Toast.LENGTH_SHORT).show();
                        DonorAccount(name,mobile,email,address,password);
                ...
                {
                    // Validation failed
                    Toast.makeText(donor_singupActivity.this, "Fail", Toast.LENGTH_SHORT).show();
                }
...
//                {
//                    Toast.makeText(donor_singupActivity.this, "All fields are required", Toast.LENGTH_SHORT).show();
//                } else
//                {
//                    boolean success = databaseHelper.addUser(name, mobile, email, address, password);
//                    if (success)
...
//                    } else
//                    {
//                        Toast.makeText(donor_singupActivity.this, "Signup failed. Try again!", Toast.LENGTH_SHORT).show();
//                    }
//                }
    ...
    private void DonorAccount(String name,String mobile,String email,String address,String password) {
        ...
        // Make API call
        Call<IsExist> call = api.DonorAccount(name,mobile,email,address,password);
